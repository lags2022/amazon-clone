...
export default function Politica() {
  return (
    <>
      <Header />
      <main className="max-w-8xl m-auto mt-10">
        <div className="pb-6 mx-8">
          <h3 className="font-bold">Privacy Policy</h3>
          <p>
            Melca Cabo built the Amz2.0 app as a Free app. This SERVICE is
            provided by Melca Cabo at no cost and is intended for use as is.
            ...
            our Terms and Conditions, which are accessible at Amz2.0 unless
        ...
        <div className="pb-6 mx-8">
          ...
          <p>
            ...
            including but not limited to Melca Cabo. The information that I
        ...
        <div className="pb-6 mx-8">
          ...
          <p>
            ...
            an error in the app I collect data and information on your phone
            called Log Data. This Log Data may include information such as your
            device Internet Protocol address, device name, operating system
        ...
        <div className="pb-6 mx-8">
          ...
          <p>
            ...
            or method of electronic storage is secure and reliable, and I
        ...
        <div className="pb-6 mx-8">
          ...
          <p>
            ...
            page. This policy is effective as of 2023-05-03
          </p>
        </div>
        <div className="pb-6 mx-8">
          ...
          <p>
            ...
            not hesitate to contact me at mdab.luis00825@gmail.com.
          </p>
        </div>
      </main>
    </>
